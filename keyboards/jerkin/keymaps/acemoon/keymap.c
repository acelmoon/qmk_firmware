...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT( //Base Layer
		...
		KC_LSFT, KC_Z, KC_X, KC_C, ALT_T(KC_V), KC_SPC, LT(2,KC_B), GUI_T(KC_N), KC_M, KC_COMM, SFT_DOT, LT(1,KC_SLSH), DEL_LT1),//LT(1,
	...
	[2] = LAYOUT( //F-Keys & Functions
		...
		MO(4), _______, _______, _______, _______, KC_PASTA, _______, _______, _______, _______, _______, _______, _______),
