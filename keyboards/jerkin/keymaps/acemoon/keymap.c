...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT( //Base Layer
		...
		KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_SPC, LT(2,KC_B), KC_N, KC_M, KC_COMM, SFT_DOT, LT(1,KC_SLSH), DEL_LT1),//LT(1,   SFT_SLS
	...
	[1] = LAYOUT( //Number & Extra Keys
		...
		_______, _______, _______, _______, KC_APP, _______, KC_BSPC, _______, _______, _______, KC_RSFT, _______, KC_DEL),//KC_PSCR
	...
	[4] = LAYOUT( //Settings
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_SLEP, KC_PWR, 
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
		_______, _______, _______, _______, _______, _______, _______, TOG_NKR, _______, _______, _______, _______, RESET),
	
	[5] = LAYOUT( //Mouse Keys
		_______, _______, _______, _______, _______, _______, _______, KC_WH_U, KC_MS_U, KC_WH_D, _______, _______, _______, 
		_______, _______, _______, _______, _______, _______, KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_R, KC_BTN1, _______, 
		_______, _______, _______, _______, _______, _______, _______, KC_WH_L, KC_WH_R, _______, _______, _______, _______),
	/*
	[6] = LAYOUT(
