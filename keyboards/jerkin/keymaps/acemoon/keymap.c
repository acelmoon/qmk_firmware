...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_CTRL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, LT(3,KC_QUOT), LT(3, KC_ENT), 
		KC_LSFT, KC_Z, KC_X, KC_C, ALT_T(KC_V), KC_SPC, LT(2,KC_B), GUI_T(KC_N), KC_M, KC_COMM, SFT_DOT, SFT_SLS, DEL_LT1),//LT(1,
	...
	[1] = LAYOUT(
		...
		_______, _______, _______, KC_APP, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, _______),

	[2] = LAYOUT(
		_______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, 
		_______, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_INS, _______, 
		_______, _______, _______, _______, _______, KC_PASTA, _______, _______, _______, _______, _______, _______, _______),

	[3] = LAYOUT(
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_UP, KC_LBRC, KC_RBRC, KC_BSLS, KC_TRNS,
