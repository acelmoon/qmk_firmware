...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN0] = LAYOUT_all(
      ...
      KC_LSFT, KC_NUHS,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_NO,   KC_RSFT, KC_DEL,
      KC_LCTRL,MO(2),    KC_LALT, KC_NO,                       KC_SPC,                  KC_NO,   KC_LGUI, MO(1),    KC_LEFT, KC_DOWN, KC_RGHT),

  //1: Numbers & F-keys
  [_FN1] = LAYOUT_all(
      KC_GRV,  KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,   KC_F11,   KC_F12, KC_TRNS,  KC_TRNS,
      KC_EQL,  KC_1,     KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,     KC_0,     KC_MINS,  KC_EQL,           KC_TRNS,
      ...
      KC_TRNS, KC_TRNS,  KC_APP,  KC_TRNS,                KC_TRNS,                      KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_MUTE,KC_VOLD,  KC_TRNS),
	  
  //2: Functions
  [_FN2] = LAYOUT_all(
      KC_GRV,  KC_F1,   KC_F2,    KC_F3,    KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,   KC_F11,   KC_F12, KC_TRNS,  KC_TRNS,
      KC_F12,  KC_F1,   KC_F2,    KC_F3,    KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,   KC_F11,   KC_F12,           KC_TRNS,
	  KC_TRNS, KC_HOME, KC_END,   KC_PGUP,  KC_PGDN, KC_INS,  KC_PAUS, KC_PSCR, KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_NO,            KC_TRNS,
	  KC_TRNS, KC_NO,   KC_MPRV,  KC_MPLY,  KC_MNXT, KC_MSTP, BL_TOGG, KC_TRNS, KC_MUTE, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,
      MO(4),   KC_TRNS, KC_MUTE,  KC_TRNS,                KC_TRNS,                       KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS),
