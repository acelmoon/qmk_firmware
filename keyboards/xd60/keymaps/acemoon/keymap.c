...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN0] = LAYOUT_all(
      ...
      KC_LSFT, KC_NO,   KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,   KC_N,   KC_M,  KC_COMM,  SFT_DOT,RSFT_T(KC_SLSH),KC_RSFT,KC_UP,KC_DEL,
      ESC_LT1, MO(2), KC_LALT,                          KC_SPC,                     SLS_LT2,MO(1),       KC_LEFT,KC_DOWN,KC_RGHT),
