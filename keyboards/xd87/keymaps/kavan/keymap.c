...
#define rgblight_set_led0		 rgblight_setrgb(100, 100, 100);
#define rgblight_set_led1        rgblight_setrgb(100, 0, 0);
#define rgblight_set_led2        rgblight_setrgb(0, 100, 0);
#define rgblight_set_led3        rgblight_setrgb(0, 100, 80);
