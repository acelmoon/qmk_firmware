...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_FN0] = LAYOUT_arrow_command(
	  ...
	  //KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		...
		KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    QUO_LT3, LT3_ENT,
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, SFT_DOT, RSF_SLS, MO(1),
		ESC_LT1, MO(2),   _______, KC_LALT,      KC_SPC,          MO(7),        SLS_LT2, _______, MO(2),   LT1_DEL),
	  //ESC_LT1, MO(2),   MO(2),   KC_LALT,      KC_SPC,          MO(7),        SLS_LT2, SLS_LT2, MO(2),   LT1_DEL),
	...
	[_FN1] = LAYOUT_arrow_command(
		...
		MO(5),   KC_NO,   _______, KC_APP,      _______,         _______,      KC_QUES, _______, _______, MO(5)),
	...
	[_FN4] = LAYOUT_arrow_command(
		TG(6),   RGB_HUI, RGB_SAI, RGB_VAI, _______, _______, _______, KC_WH_U, KC_MS_U, KC_WH_D, KC_SLEP, KC_PWR,
		RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_M_P, _______, KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_R, KC_BTN1, KC_BTN1,
		_______, BL_DEC,  BL_TOGG, BL_INC,  RGB_TOG, _______, TOG_NKR, KC_WH_L, KC_WH_R, _______, _______, _______,
...
#define rgblight_set_led0		 rgblight_setrgb(0, 0, 0);
